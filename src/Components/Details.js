...
class Details extends React.Component {
    ...
    componentDidMount()
    {
        ...
        axios({
            url:`https://infinite-sea-51054.herokuapp.com/getRestaurantById/${resId}`,
            method:'GET',
    ...
    handleclick=(state,value)=>{
      ...
      {
         axios({
             url:`https://infinite-sea-51054.herokuapp.com/getrestauantbyitem/${restaurantId}`,
             method:'GET',
             headers:{'content-Type':'application/json'}
         })
...
this.setState({items:items, subTotal:total})
    ...
    getData = (data) => {
        return fetch(`https://infinite-sea-51054.herokuapp.com/payment`, {
            method: "POST",
            headers: {
    ...
    makePayment = (e) => {
        ...
        axios({
            url:'https://infinite-sea-51054.herokuapp.com/signup',
            method:'POST',
            headers:{'content-Type':'application/json'},
            data:
            {
